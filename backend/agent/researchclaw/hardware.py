...
def ensure_torch_available(python_path: str, gpu_type: str) -> bool:
    ...
    """
    if os.environ.get("RESEARCHCLAW_SKIP_TORCH_INSTALL", "").lower() in {"1", "true", "yes"}:
        logger.info("Skipping PyTorch auto-install because RESEARCHCLAW_SKIP_TORCH_INSTALL is set")
        return False
