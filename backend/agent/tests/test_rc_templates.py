...
class TestExportConfig:
    ...
    def test_rcconfig_has_export(self) -> None:
        ...
        cfg = RCConfig.load("examples/config_template.yaml", check_paths=False)
    ...
    def test_rcconfig_export_from_dict(self) -> None:
        ...
        data = yaml.safe_load(Path("examples/config_template.yaml").read_text())
        data["export"] = {
...
class TestHitlStageValidation:
    """Test that hitl_required_stages accepts the complete S1-S26 pipeline."""
    ...
    def test_stage_23_valid(self) -> None:
        ...
        data = yaml.safe_load(Path("examples/config_template.yaml").read_text())
        data.setdefault("security", {})["hitl_required_stages"] = [1, 23, 26]
