...

{
  ...
  "results": [
    ...
    },
    {
      ...
      "title": "From Lab to Real World: Assessing the Ef
...
The remainder of this paper is organized as follows: Section 2 reviews HAR baselines and evaluation practice.
